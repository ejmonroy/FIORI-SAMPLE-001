sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("df/training/sample001/FIORI-SAMPLE-001/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#FIORISAMPLE001-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#FIORISAMPLE001-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("df.training.sample001.FIORI-SAMPLE-001.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["df/training/sample001/FIORI-SAMPLE-001/localService/mockserver"], function (mockserver) {
